<template>
  <footer class="px-3 py-8 text-gray-500 transition-colors duration-200 border-t border-gray-200 text-2 mx-auto">
    <div class="flex flex-col">
      <div class="flex flex-col md:mt-0 md:flex-row justify-between">
        <nav class="w-1/6 flex flex-col items-center justify-center flex-1 border-gray-100 md:items-end md:border-r md:pr-5">
        ...
        <div class="w-2/3 flex flex-col items-center justify-center flex-1 border-gray-100 md:mt-0 md:border-r">
          ...
          <a class="text-gray-500 hover:text-gray-700" href="https://github.com/youngho98/sponity" target="_blank">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor"
              class="text-xl transition-colors duration-200 hover:text-700" viewBox="0 0 1792 1792">
              <path
        ...
        <div class="w-1/6 flex flex-col items-center justify-center text-sm flex-1 mt-7 md:mt-0 md:items-start md:pl-5">
