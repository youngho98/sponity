      ...
      <form action="#" autoComplete="off">
        <div class="flex flex-col mb-2">
          <div class="flex relative ">
            ...
            <input type="text" id="sign-in-id" v-model="loginInfo.userId"
        ...
        <div class="flex flex-col mb-6">
          <div class="flex relative ">
            ...
            <input type="password" id="sign-in-password" v-model="loginInfo.password"
              class=" rounded-r-lg flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-green-600 focus:border-transparent"
        ...
        <div class="flex items-center mb-6 -mt-4">
          <div class="flex ml-auto">
            <a href="#" class="inline-flex text-sm font-thin text-gray-500 hover:text-gray-700">
...
const login = function () {
  axios.post("http://localhost:8080/user/login", loginInfo.value)
    .then(() => {
